...
<body onload="init();">
    ...
    <div id="topics">
        <h3></h3>
        <div class="toc">         
            <p><a href="#" id="math">Philosophy of Math</a></p>
            <p><a href="#" id="edu">Philosophy of Education</a></p>
            <p><a href="#" id="disc">Philosophy of Discipline</a></p>
        </div>
    </div>
    
    <div class="clearfloat"></div>
        
        <div id="c_math" class="content">
            <H3>Philosophy of Math</H3>

            

        </div>
  
        <div id="c_edu" class="content">
            <H3>Philosophy of Education</H3>

            

        </div>
    
        <div id="c_disc" class="content">
            <H3>Philosophy of Discipline</H3>
