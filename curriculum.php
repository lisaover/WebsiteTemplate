...
<body onload="init();">
    ...
    <div id="topics">
        <h3></h3>
        <div class="toc">         
            <p><a href="#" id="curriculum">Lay a Foundation Curriculum Proposal</a></p>
            <p><a href="#" id="unit-plan">Geometry Unit Plan</a></p>
        </div>
    </div>
    
    <div class="clearfloat"></div>
        
        <div id="c_curriculum" class="content">
            <H3>Lay a Foundation Curriculum Proposal</H3>

            

        </div>
  
        <div id="c_unit-plan" class="content">
            <H3>Geometry Unit Plan</H3>
